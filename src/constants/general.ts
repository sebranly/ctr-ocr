...
export const WEBSITE_DESCRIPTION = `Uploads your in-game screenshots of Crash Team Racing: Nitro-Fueled and convert them into results data`;
...
export const CANONICAL_URL = 'https://www.crashteamresults.com';
